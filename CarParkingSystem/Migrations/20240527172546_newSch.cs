...
{
    public partial class newSch : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    inBreak = table.Column<TimeSpan>(type: "time", nullable: false),
                    outBreak = table.Column<TimeSpan>(type: "time", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedule_Shifts_shiftId",
                        column: x => x.shiftId,

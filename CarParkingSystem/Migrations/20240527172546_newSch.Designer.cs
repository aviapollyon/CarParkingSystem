...
namespace CarParkingSystem.Migrations
{
    ...
    [Migration("20240527172546_newSch")]
    partial class newSch
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarParkingSystem.Models.FaultReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarParkingSystem.Models.FaultReportMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MessageReport")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("CarParkingSystem.Models.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarParkingSystem.Models.Shift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<TimeSpan>("inBreak")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("inTime")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("outBreak")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("CarParkingSystem.Models.Schedule", b =>
                {
                    b.HasOne("CarParkingSystem.Models.Shift", "Shift")
                        .WithMany()
